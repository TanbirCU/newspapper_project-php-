                ...
                <div class="col-md-8">
                  <!-- post-container -->
                    ...
                    <?php
                        ...
                        $post_id=$_GET['id'];
                        $sql="SELECT post.post_id,post.title,post.description,post.post_date,category.category_name,user.username,
                        ...
                        <div class="post-content single-post">
                            ...
                            <!-- image upload korte index page theke copy korte hbe -->
                            <p class="description">
